...
## This type: G0V, metal-weak (Pickles "w" variant)
The `w` prefix denotes Pickles' metal-weak variant, not a distinct MK class: at the same nominal G0V spectral and luminosity class, reduced metal abundance weakens the Ca II H & K lines, the CH G band, and the Fe I/Mg b/Na D lines relative to a solar-abundance G0V, with less blue/violet line blanketing than the normal-metallicity star.

## Features
| Wavelength (Å) | Feature | Notes |
|---|---|---|
| 3933-3968 | Ca II K & H | strong but weakened relative to solar-metallicity G0V |
| 4226 | Ca I | weak, reduced by low metallicity |
| 4300-4315 | CH G band | class-defining but shallower than normal G0V |
| 4340 | Hγ | moderate, comparatively more conspicuous with weaker line blanketing |
| 4770-4790 | MgH band | very weak, reduced by low metallicity |
| 4861 | Hβ | moderate, fairly prominent at this early subclass |
| 5167-5184 | Mg b triplet | present but weakened by low metallicity |
| 5890-5896 | Na D | weak, reduced by low metallicity |
| 6563 | Hα | moderate |
