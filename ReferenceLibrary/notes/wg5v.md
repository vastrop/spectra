...
## This type: G5V, metal-weak (Pickles "w" variant)
The `w` prefix denotes Pickles' metal-weak variant, not a distinct MK class: at the same nominal G5V spectral and luminosity class, reduced metal abundance weakens the G band, Ca II H & K, and Mg b/Na D lines relative to a solar-abundance G5V, with less blue/violet line blanketing than the normal-metallicity star.

## Features
| Wavelength (Å) | Feature | Notes |
|---|---|---|
| 3933-3968 | Ca II K & H | strong but weakened relative to solar-metallicity G5V |
| 4226 | Ca I | weak, reduced by low metallicity |
| 4300-4315 | CH G band | class-defining but shallower than normal G5V |
| 4340 | Hγ | weakening relative to G0-G2 |
| 4770-4790 | MgH band | gravity-sensitive dwarf indicator, weakened by low metallicity |
| 4861 | Hβ | weakening |
